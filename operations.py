...
OPS = {
  ...
  # 'PyConv2' : lambda C, stride, affine: PyConv2(C, C, stride,  affine=affine),
  # 'PyConv3' : lambda C, stride, affine: PyConv3(C, C, stride,  affine=affine),
...
class PyConv3(nn.Module):
    ...
    def __init__(self, inplans, planes, stride=1, affine=True):
